...
<html lang="en"><head>
    ...
    <link rel="stylesheet" href="<?php echo URL_TEMPLATE_ADMIN ?>assets/vendor/@fortawesome/fontawesome-free/css/all.min.css"><!-- END PLUGINS STYLES -->
    <!-- BEGIN THEME STYLES -->
    <link rel="stylesheet" href="<?php echo URL_TEMPLATE_ADMIN ?>assets/stylesheets/theme.min.css" data-skin="default">
    <link rel="" href="<?php echo URL_TEMPLATE_ADMIN ?>assets/stylesheets/theme-dark.min.css" data-skin="dark" disabled="true">
  ...
  <body class="default-skin">
    ...
    <main class="auth">
      <header id="auth-header" class="auth-header" style="background-image: url(assets/images/illustration/img-1.png);">
        ...
        <p> Bạn chưa có tài khoản? <a href="auth-signup.html">Đăng kí</a>
        </p>
      </header><!-- form -->
      <form class="auth-form" action="?mod=admin&c=auth&act=checkLogin" method="post">
        <!-- .form-group -->
        <div class="form-group">
          <div class="form-label-group">
            <input type="text" id="inputUser" name="email" class="form-control placeholder-shown" placeholder="Username" autofocus=""> <label for="inputUser">Email</label>
          </div>
        </div><!-- /.form-group -->
        <!-- .form-group -->
        <div class="form-group">
          <div class="form-label-group">
            <input type="password" id="inputPassword" name="password" class="form-control placeholder-shown" placeholder="Password"> <label for="inputPassword">Mật khẩu</label>
          </div>
        </div><!-- /.form-group -->
        <!-- .form-group -->
        <div class="form-group">
      ...
      <!-- copyright -->
      <footer class="auth-footer"> © 2020 by Lê Hồng Minh.
      </footer>
    </main><!-- /.auth -->
    <!-- BEGIN BASE JS -->
    <script src="<?php echo URL_TEMPLATE_ADMIN ?>assets/vendor/jquery/jquery.min.js"></script>
    <script src="<?php echo URL_TEMPLATE_ADMIN ?>assets/vendor/popper.js/umd/popper.min.js"></script>
    <script src="<?php echo URL_TEMPLATE_ADMIN ?>assets/vendor/bootstrap/js/bootstrap.min.js"></script> <!-- END BASE JS -->
    <!-- BEGIN PLUGINS JS -->
    <script src="<?php echo URL_TEMPLATE_ADMIN ?>assets/vendor/particles.js/particles.js"></script>
    <script>
      /**
      ...
      $(document).on('theme:init', () =>
      {
        ...
        particlesJS.load('auth-header', '<?php echo URL_TEMPLATE_ADMIN ?>assets/javascript/pages/particles.json');
      })
    </script> <!-- END PLUGINS JS -->
    <!-- BEGIN THEME JS -->
    <script src="<?php echo URL_TEMPLATE_ADMIN ?>assets/javascript/theme.js"></script> <!-- END THEME JS -->
